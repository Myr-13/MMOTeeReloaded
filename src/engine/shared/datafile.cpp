...
bool CDataFileWriter::OpenFile(class IStorageTW *pStorage, const char *pFilename, int StorageType)
{
...
bool CDataFileWriter::Open(class IStorageTW *pStorage, const char *pFilename, int StorageType)
{
	Init();
